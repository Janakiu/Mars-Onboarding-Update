...
namespace SpecflowTests.AcceptanceTest
{
    ...
    public class SpecFlowFeature1Steps : Utils.Start
    {
        ...
        public void WhenIWantToEditExsistingLanguage()
        {
            ...
            //update language
            Driver.driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[2]/div/div[2]/div/table/tbody/tr/td/div/div[1]/input")).SendKeys("French");
        ...
        public void ThenThatLanguageShouldNotBeBeDisplayedOnMyListings()
        {
            try
            {
                ...
                string ActualValue = Driver.driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[2]")).Text;
                Thread.Sleep(500);
                if (ActualValue == null)
                {
